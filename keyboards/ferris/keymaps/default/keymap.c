...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [2] = LAYOUT_split_3x5_2(KC_NO, KC_AT, KC_NO, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, LALT(KC_TAB), LSA(KC_TAB), LALT(KC_F4), KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_CAPS, CW_TOGG, LCTL(KC_PGUP), LCTL(KC_PGDN), LALT(KC_GRV), GOOGLE_FIRST_RESULT, KC_APP, LCTL(KC_GRV), KC_TRNS, KC_RCTL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
