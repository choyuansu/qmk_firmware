...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [0] = LAYOUT_split_3x5_2(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_QUOT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, LT(3,KC_ESC), LT(1,KC_BSPC), KC_SPC, LT(2,KC_TAB)),
        [1] = LAYOUT_split_3x5_2(KC_APP, KC_TRNS, LSA(KC_LEFT), LSA(KC_RGHT), LCTL(KC_EQL), KC_PGUP, KC_HOME, KC_UP, KC_END, KC_PSCR, CW_TOGG, KC_TRNS, LCTL(KC_PGUP), LCTL(KC_PGDN), LCTL(KC_MINS), KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_ENT, KC_CAPS, KC_RCTL, LCA(KC_MINS), LCTL(LSFT(KC_MINS)), KC_TRNS, KC_TRNS, KC_DEL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(4), KC_TRNS),
        [2] = LAYOUT_split_3x5_2(KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_COLN, KC_SCLN, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, TD(TD_BSLS_PIPE), TD(TD_BRCS), TD(TD_CBRS), TD(TD_PRNS), KC_PLUS, KC_MINS, KC_EQL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
