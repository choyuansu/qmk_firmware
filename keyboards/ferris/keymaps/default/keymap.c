...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [2] = LAYOUT_split_3x5_2(KC_NO, KC_NO, KC_NO, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_NO, KC_NO, KC_NO, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_CAPS, CW_TOGG, LCTL(KC_PGUP), LCTL(KC_PGDN), KC_NO, GOOGLE_FIRST_RESULT, KC_APP, KC_NO, KC_TRNS, KC_RCTL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
        ...
        [7] = LAYOUT_split_3x5_2(KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_0, KC_9, KC_8, KC_7, KC_6, KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_5, KC_4, KC_3, KC_2, KC_1, KC_LCTL, KC_LSFT, KC_M, KC_C, KC_V, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, SH_MON, KC_SPC, KC_NO, KC_NO)
};
